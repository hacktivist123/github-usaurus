...
:::important
This template includes writing instructions and boilerplate text that you can customize, use as-is, or completely replace with your own text. This text is indicated in [square brackets]. Make sure you replace the placeholders with your own text.
This admonition should be deleted.
:::

In this tutorial, you'll see how to [insert brief description of the main tutorial task]. This tutorial is intended for [audience]. It assumes you have knowledge of:
